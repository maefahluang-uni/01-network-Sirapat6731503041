[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=20028214)
...
```
 The main() method creates and starts two MockWebServer instances on ports 8080 and 8081. It then waits for any key press from the user to stop both servers.
```
...
Create more threads with different ports.  
Edit the response string to add HTML elements.  
It allows handling more clients or services at the same time.
```
